...
// ✅ MOIDA BARAKA LOGO - Client uchun (tagline siz)
const MoidaBarakaLogo = ({ size = "normal" }) => {
  const height = size === "small" ? "40" : "50";
  const iconScale = size === "small" ? 0.8 : 1;
  ...
  return (
    ...
    >
      {/* Icon - Elegant Plate with Fork & Knife */}
      <g transform={`translate(10, 10) scale(${iconScale})`}>
        <circle cx="20" cy="20" r="18" fill="none" stroke="#004332" strokeWidth="2.5"/>
        <circle cx="20" cy="20" r="14" fill="none" stroke="#004332" strokeWidth="1.5" opacity="0.3"/>
        
        {/* Fork */}
        <g transform="translate(12, 15)">
          <line x1="0" y1="0" x2="0" y2="12" stroke="#004332" strokeWidth="1.6" strokeLinecap="round"/>
          <line x1="-2.5" y1="0" x2="-2.5" y2="6" stroke="#004332" strokeWidth="1.4" strokeLinecap="round"/>
          <line x1="2.5" y1="0" x2="2.5" y2="6" stroke="#004332" strokeWidth="1.4" strokeLinecap="round"/>
        </g>
        
        {/* Knife */}
        <g transform="translate(28, 15)">
          <line x1="0" y1="0" x2="0" y2="12" stroke="#004332" strokeWidth="1.8" strokeLinecap="round"/>
          <path d="M -1.5,-1.5 L 1.5,-1.5 L 0,1.5 Z" fill="#004332"/>
        </g>
        
        <circle cx="20" cy="20" r="2.5" fill="#00664a"/>
      </g>
