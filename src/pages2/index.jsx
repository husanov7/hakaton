...
<h2 className="text-xl text-center font-bold mb-4">Корзина</h2>
    ...
    <div className="p-4 max-w-md m-auto bg-white rounded-lg border-solid border-[1px] border-[] shadow-lg shadow-[#ccc]">
      <div className="flex items-center mb-4">
        <img src="https://avatars.mds.yandex.net/i?id=b93ecc6734ad42feec9730a3a42ca448884bd1283ab973b0-12643411-images-thumbs&n=13" alt="Product Image" className="w-[150px] h-[120px] rounded-[20px] mr-4" />
      ...
      <div> 
        <p className="mb-1 p-[5px]">Сумма заказа: {totalPrice.toLocaleString()} UZS</p>
        <p className="mb-1 p-[5px]">Обслуживание 10%: {serviceCharge.toLocaleString()} UZS</p>
        <p className="font-bold p-[5px]">Итоговая сумма заказа: {finalPrice.toLocaleString()} UZS</p>
      </div>
    </div>
    </>
