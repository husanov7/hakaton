    ...
    <div className="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="modal pt-4">
            <button className="w-full md:w-[400px] bg-blue-500 text-white h-12 rounded-2xl" onClick={handleOpen}>собшите нам</button>
            <Dialog open={open} handler={handleOpen}>
              <DialogHeader>Massage</DialogHeader>
              <DialogBody className="flex flex-col gap-4">
                <form onSubmit={newMessage} className="flex flex-col gap-4">
        ...
        <div className="pt-4">
          <p className="text-gray-700 mb-4">Адрес: </p>
          <p className="text-black font-semibold mb-4 text-lg">ул. Мукуми 200</p>
        </div>
        <div className="space-y-2 p-2">
          ...
          <hr />
          <a href="https://www.instagram.com/m1rkomilovv/?next=%2F" className="text-blue-500 p-2">
            Instagram
          </a>
        </div>
        <hr />
